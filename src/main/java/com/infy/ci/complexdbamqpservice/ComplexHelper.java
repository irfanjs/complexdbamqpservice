...
public class ComplexHelper {
	 static Logger log = Logger.getLogger(ComplexHelper.class.getName());
	
	static private ComplexHelper cihelper;
	...
	public static ComplexHelper getInstance(){
		synchronized (cihelperLock) {
			if(null == cihelper){
				cihelper = new ComplexHelper();
			}
		}
		return cihelper;
	}
